/*
  # Fix Documents Storage Bucket Configuration

  1. Storage Setup
    - Update documents bucket with proper configuration
    - Ensure all necessary MIME types are allowed
    - Set appropriate file size limit
  
  2. Security Policies
    - Create clear, unambiguous policies for the documents bucket
    - Ensure authenticated users can manage their own documents
    - Allow public read access for document sharing
*/
