/*
  # Create memoria_profiles table for MEMORIA module (Fixed Version)
...
BEGIN
    ...
    IF EXISTS (
        ...
        DROP POLICY "Users can insert their own memoria profiles" ON memoria_profiles;
    END IF;
    ...
    IF EXISTS (
        ...
        DROP POLICY "Users can update their own memoria profiles" ON memoria_profiles;
    END IF;
    ...
    IF EXISTS (
        ...
        DROP POLICY "Users can delete their own memoria profiles" ON memoria_profiles;
    END IF;
    ...
    IF EXISTS (
        ...
        DROP POLICY "Users can view their own memoria profiles" ON memoria_profiles;
    END IF;
END $$;
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE tgname = 'handle_memoria_profiles_updated_at'
  ) THEN
